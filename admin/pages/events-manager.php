  ...
  <div class="admin-layout">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar__group"><div class="sidebar__group-label">Navigation</div>
        ...
        <a href="events-manager.php" class="sidebar__link active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>Events</a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="events-manager.php?edit=<?php echo $event['id']; ?>" 
                       class="btn btn--ghost btn--sm" title="Edit">✏️</a>
                    
                    <!-- Delete link: goes to same page with ?delete=ID -->
                    <a href="events-manager.php?delete=<?php echo $event['id']; ?>" 
                       class="btn btn--ghost btn--sm" title="Delete"
                       onclick="return confirm('Are you sure you want to delete this event?');">🗑️</a>
                  </td>
                </tr>
                <?php endwhile; ?>
