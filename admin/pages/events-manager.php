        ...
        <div class="card mb-3">
          <div class="card__header">
            <div class="card__title">
              <?php echo $edit_event ? '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/></svg> Edit Event' : 'Add New Event'; ?>
            </div>
          </div>
              ...
              <div class="form-grid">
                ...
                <div class="form-group" style="grid-column: 1 / -1; padding-top:10px; border-top:1px solid #e5e7eb;">
                  ...
                  <input type="text" name="notif_msg" class="form-input"
                    placeholder="Notification Message (e.g. Join our AI webinar tomorrow at 3 PM)"
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="events-manager.php?edit=<?php echo $event['id']; ?>" class="btn btn--ghost btn--sm"
                        title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          viewBox="0 0 16 16">
                          <path
                      ...
                      <a href="events-manager.php?delete=<?php echo $event['id']; ?>" class="btn btn--ghost btn--sm"
                        title="Delete" onclick="return confirm('Are you sure you want to delete this event?');"><svg
