  ...
  <div class="admin-layout">
    ...
    <div class="admin-main">
      ...
      <div class="admin-content">
        ...
        <div class="card mb-3">
          <div class="card__header"><div class="card__title">Change Username</div></div>
          <div class="card__body">
            <form method="POST" action="">
              <div class="form-group">
                <label class="form-label">Current Username</label>
                <input type="text" class="form-input" value="<?php echo htmlspecialchars($current_username); ?>" disabled>
              </div>
              <div class="form-group">
        ...
        <div class="card">
          <div class="card__header"><div class="card__title">Change Password</div></div>
          <div class="card__body">
            <form method="POST" action="">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="password" name="new_password" class="form-input" placeholder="Enter new password (min 6 chars)" required>
              </div>
              <div class="form-group">
