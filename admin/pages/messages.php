  ...
  <div class="admin-layout">
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar__group">
        ...
        <a href="libraries-manager.php" class="sidebar__link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>Libraries</a>
        ...
        <a href="messages.php" class="sidebar__link active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div class="admin-content">
        <div class="page-header">
          <div class="page-header__left">
            <h1>Messages</h1>
            <p>View and manage contact messages, book & journal recommendations</p>
          </div>
        </div>
        ...
        <div class="table-tabs" style="margin-bottom:20px;">
          <a href="messages.php?tab=contacts"
            class="table-tab <?php echo $tab == 'contacts' ? 'active' : ''; ?>">Contact Messages <span
              class="table-tab__count"><?php echo $c_contacts; ?></span></a>
          <a href="messages.php?tab=books" class="table-tab <?php echo $tab == 'books' ? 'active' : ''; ?>">Book
            Recommendations <span class="table-tab__count"><?php echo $c_books; ?></span></a>
          <a href="messages.php?tab=journals"
            class="table-tab <?php echo $tab == 'journals' ? 'active' : ''; ?>">Journal Recommendations <span
              class="table-tab__count"><?php echo $c_journals; ?></span></a>
          <a href="messages.php?tab=enquiries"
            class="table-tab <?php echo $tab == 'enquiries' ? 'active' : ''; ?>">Enquiries <span
              class="table-tab__count"><?php echo $c_enquiries; ?></span></a>
        </div>
            ...
            <table class="data-table">
              ...
              <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                  <tr>
                    <?php if ($tab == 'contacts'): ?>
                      <td class="cell-title"><?php echo htmlspecialchars($row['name']); ?><br><small
                          style="color:#999;"><?php echo htmlspecialchars($row['email']); ?></small></td>
                      <td><?php echo htmlspecialchars($row['subject']); ?></td>
                      <td style="max-width:200px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                        <?php echo htmlspecialchars($row['message']); ?>
                        <br><button type="button" class="btn btn--ghost btn--sm"
                          style="color:var(--clr-primary); margin-top:4px;"
                          data-msg="<?php echo htmlspecialchars($row['message']); ?>" onclick="viewFullMessage(this)">Read
                          More</button>
                      </td>
                    ...
                    <?php elseif ($tab == 'books'): ?>
                      ...
                      <td>
                        <a href="messages.php?tab=books&delete=<?php echo $row['id']; ?>&table=book_recommendations"
                          class="btn btn--ghost btn--sm" onclick="return confirm('Delete this recommendation?');" title="Delete"><svg
  ...
  <div class="modal-overlay" id="readMessageModal">
    <div class="modal" style="max-width:600px;">
      <div class="modal__header">
        <h2 class="modal__title">Full Message</h2>
        <button class="modal__close" onclick="closeModal('readMessageModal')"><svg xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <line x1="18" y1="6" x2="6" y2="18" />
            <line x1="6" y1="6" x2="18" y2="18" />
          </svg></button>
      </div>
      <div class="modal__body" id="readMessageBody"
        style="white-space: pre-wrap; font-size: 14px; line-height: 1.6; color: #444;">
      </div>
      <div class="modal__footer">
        <button class="btn btn--primary" onclick="closeModal('readMessageModal')">Close</button>
      </div>
    </div>
  </div>

  <script>
    function viewFullMessage(btn) {
      if (typeof openModal === 'undefined') {
        // Fallback if openModal isn't loaded from admin.js
        window.openModal = function (id) { document.getElementById(id).classList.add('active'); };
        window.closeModal = function (id) { document.getElementById(id).classList.remove('active'); };
      }
      var msg = btn.getAttribute('data-msg');
      document.getElementById('readMessageBody').textContent = msg;
