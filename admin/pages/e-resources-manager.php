      ...
      <div class="admin-content">
        ...
        <div class="card mb-3">
          <div class="card__header">
            <div class="card__title"><?php echo $edit ? '✏️ Edit Resource' : '➕ Add New Resource'; ?></div>
          </div>
        ...
        <div class="table-tabs" style="margin-bottom:20px;">
          <a href="e-resources-manager.php?cat=all" class="table-tab <?php echo $tab == 'all' ? 'active' : ''; ?>">All <span
              class="table-tab__count"><?php echo $count_all; ?></span></a>
